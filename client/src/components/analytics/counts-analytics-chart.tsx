...
export function DailyVisitorSearchesAnalyticsChart() {
  ...
  return (
    <Card className="@container/card">
      <CardHeader className="relative">
        <CardTitle>Visitors & Searches</CardTitle>
        <CardDescription>
            ...
            <AreaChart data={filteredData}>
              <defs>
                <linearGradient id="fillVisitors" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#2662d9" stopOpacity={1.0} />
